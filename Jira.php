...
class JiraPlugin extends MantisPlugin
{
    ...
    function bug_update($p_event, $p_old, &$p_new)
    {
        ...
        if ($t_tran_id != 0) {
            ...
            $this->call('issue', array('transition', 'to', $t_issueid, $t_target_status_id));
        }
    }
    ...
    function bugnote_add($p_event_name, $p_bug_id, $p_bugnote_id, $p_files)
    {
        ...
        if ($t_bug && $t_bug->reporter_id != $this->jira_user_id) {
            return;
        }
            ...
            if ($t_bugnote->reporter_id == $this->skip_reporter_id) {
                ...
                if ($t_nxt != 0) {
                    ...
                    if ($t_nxt == 50) {
                        ...
                        $this->call('issue', array('transition', 'to', $t_issueid, 'IN_PROGRESS'));
                    }
                }
