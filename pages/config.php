...
<?php echo form_security_field( 'plugin_jira_config_edit' ) ?>
...
<tr>
	<th class="category width-40">
		<?php echo plugin_lang_get( $k )?>
	</th>
	<td class="center" width="20%">
		<input type="text" class="ace" name="<?php echo $k; ?>" value="<?php echo plugin_config_get( $k, '' ); ?>" />
	</td>
</tr>
<?php } ?>
